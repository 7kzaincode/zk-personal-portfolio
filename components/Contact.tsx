...
const Contact: React.FC = () => {
  return (
    <section id="contact" className="min-h-[50vh] flex flex-col items-center justify-center px-8 md:px-24 text-center bg-white dark:bg-neutral-950">
      <div className="serif text-7xl md:text-[14rem] mb-16 tracking-tighter leading-none italic font-black text-black dark:text-white">
        Collaborate.
      </div>

      <a
        href="mailto:kn.zain@hotmail.com"
        className="text-4xl md:text-6xl border-b-2 border-current pb-10 hover:opacity-40 transition-all mb-24 inline-block font-light tracking-tighter italic"
      >
        kn.zain@hotmail.com
      </a>
      ...
      <div className="mt-20 text-[11px] font-mono uppercase tracking-[1.5em] opacity-20 font-black">
